...
(defgeneric image-rgba-get-fn (image &key dx dy))
...
(defgeneric image-gray-get-fn (image &key dx dy))
...
(defgeneric image-alpha-get-fn (image &key dx dy))
(defmethod image-alpha-get-fn ((image gray-image-mixin) &key (dx 0) (dy 0))
  (image-gray-get-fn image :dx dx :dy dy))
(defmethod image-alpha-get-fn ((image rgba-image-mixin) &key (dx 0) (dy 0))
  #+nil(warn "using unoptimized function: image-alpha-get-fn")
  (let ((fn (image-rgba-get-fn image :dx dx :dy dy)))
