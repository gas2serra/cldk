...
(defgeneric color->octets (color)
  (:method ((color cl-colors:rgb))
    (values (color-value->octet (cl-colors:rgb-red color))
            (color-value->octet (cl-colors:rgb-green color))
            (color-value->octet (cl-colors:rgb-blue color)))))
