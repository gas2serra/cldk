...
;;; screens
(defmethod driver-screen-num ((driver xcb-driver))
  (with-slots (display) driver
    (setup-roots-length (get-setup display))))

(defmethod driver-screen-size ((driver xcb-driver) screen-index units)
...
(defmethod driver-screen-dpi ((driver xcb-driver) screen-index)
  (multiple-value-bind (w h)
      (driver-screen-size driver screen-index :device)
    (multiple-value-bind (in-w in-h)
        (driver-screen-size driver screen-index :inches)        
