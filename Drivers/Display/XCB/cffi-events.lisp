...
(cffi:defcstruct ES-keymap-notify
  (response-type  :uint8)
  (keys           :uint8 :count 31))


(cffi:defcstruct ES-expose
  (response-type  :uint8)
  (pad0           :uint8) 
  (sequence       :uint16)
  (window         window-t)
...
(cffi:defcstruct ES-graphic-expose
  (response-type  :uint8)
  (detail         :uint8)
  (sequence       :uint16)
  (drawable       :uint32)
...
(cffi:defcstruct ES-VISIBILITY-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (window         window-t)
...
(cffi:defcstruct ES-CREATE-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (parent         window-t)
...
(cffi:defcstruct ES-DESTROY-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (event          window-t)
...
(cffi:defcstruct ES-UNMAP-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (event          window-t)
...
(cffi:defcstruct ES-REPARENT-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (event          window-t)
...
(cffi:defcstruct ES-GRAVITY-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (event          window-t)
...
(cffi:defcstruct ES-RESIZE-REQUEST
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (window         window-t)
...
(cffi:defcstruct ES-CIRCULATE-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (event          window-t)
...
(cffi:defcstruct ES-PROPERTY-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (window         window-t)
...
(cffi:defcstruct ES-SELECTION-CLEAR
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (time           timestamp-t)
...
(cffi:defcstruct ES-SELECTION-REQUEST
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (time           timestamp-t)
...
(cffi:defcstruct ES-SELECTION-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (time           timestamp-t)
...
(cffi:defcstruct ES-COLORMAP-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (window         window-t)
...
(cffi:defcstruct ES-CLIENT-MESSAGE
  (response-type  :uint8)   
...
(cffi:defcstruct ES-MAPPING-NOTIFY
  (response-type  :uint8)
  (pad0           :uint8)
  (sequence       :uint16)
  (request        :uint8)
...
(cffi:defcfun ("xcb_wait_for_event" wait-for-event) :pointer
  (c        :pointer))

(cffi:defcfun ("xcb_poll_for_event" poll-for-event) :pointer
  (c        :pointer))



(cffi:defcfun ("xcb_key_symbols_alloc" key-symbols-alloc) :pointer
  (c        :pointer))
